                ...
                <div className='col mt-3 '>
                    <div className='border-bottom'>
                        <div className='d-flex justify-content-between  align-items-center mb-3'>
                            <div className='col'>
                                <span className='h2 fw-bold'>ADX</span>
                            </div>
                            {/* MODEL START */}
                            <div>
                    ...
                    <table class="table mt-5 h4">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>1691129989412-447343242-Screenshot (71).png</td>
                                <td>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td>1691130359379-460136172-1691130359379-Screenshot (72).png</td>
                                <td>
                                    <div className='d-flex gap-2 h3'>
                                        <a href="#"><FaEdit /></a>
                                        <a href="#"><MdDelete /></a>
