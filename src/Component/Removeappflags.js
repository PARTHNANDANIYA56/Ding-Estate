                        ...
                        <div className='col'>
                            ...
                            <div className='d-flex gap-5 mt-5'>
                                <div className='fw-bold h3'>
                                    <span>App Remove Flags</span>
                                </div>
                                <div className='gap-5 d-grid'>
                                    <div className='h4 d-flex  gap-5'>
                                        <span >Flag </span>
                                        <input type="radio" />Force Update
                                        <input type="radio" />Skip Update
                                        <input type="radio" />MoveApp
